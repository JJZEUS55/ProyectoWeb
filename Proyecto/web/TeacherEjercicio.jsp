                    ...
                    <s:form action="/All/addEjercicio" theme="simple" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-3">
                                    <s:hidden value="0" name="int4solveiz1" cssClass="form-control"/>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-2">
                                ...
                                <div class="col-3">
                                    <s:hidden value="0" name="int4solveiz2" cssClass="form-control"/>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-2">
                                ...
                                <div class="col-3">
                                    <s:hidden value="0" name="int4solveiz3" cssClass="form-control"/>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-2">
                                ...
                                <div class="col-3">
                                    <s:hidden value="0" name="int4solveder1" cssClass="form-control"/>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-2">
                                ...
                                <div class="col-3">
                                    <s:hidden value="0"name="int4solveder2" cssClass="form-control"/>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-2">
                                ...
                                <div class="col-3">
                                    <s:hidden value="0" name="int4solveder3" cssClass="form-control"/>
                                </div>
                            </div>                            
